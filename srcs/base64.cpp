...
std::string base64_decode(std::string const& encoded_string)
{
	...
	while (in_len-- && encoded_string[in_] != '=' && is_base64(encoded_string[in_]))
	{
		...
		if (i == 4)
		{
			...
			char_array_3[0] = static_cast<char>(char_array_4[0] << 2) + static_cast<char>((char_array_4[1] & 0x30) >> 4);
			char_array_3[1] = static_cast<char>((char_array_4[1] & 0xf) << 4) + static_cast<char>((char_array_4[2] & 0x3c) >> 2);
